...
Demostrates the early-fetch of cli options by utalm, type 
	...
	demo.sh -d l:1,file:\$PWD/demo.sh
	demo.sh -d l:1,file:\$PWD/demo.sh%exclude
	demo.sh -d l:1,file:\$PWD/utalm-bash.conf
	demo.sh -d l:1,file:\$PWD/utalm-bash.conf%include
	demo.sh -d l:1,file:\$PWD/utalm-bash.conf%exclude
