...
r=$(utalm-bash-cli.sh -d w:4,s:3,i:4,l:10,f:callname%filename%subsysstr%nocolor callErrOutWrapper $LINENO $BASH_SOURCE "echo 'BCD-Here it is'")
r=${r// /}
assert $LINENO $BASH_SOURCE "[[ "$r" == 'BCD-Hereitis' ]]"
## \endcond
