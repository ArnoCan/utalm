...
TXTTOTAGSINCLUDE=$(shell X=$(BLD_ROOT)src/lib/Makefile.lib/Makefile-txt2tags-rules.mk;if [ -e $$X ];then echo $$X; \
    else  X=$(BLD_ROOT)lib/Makefile.lib/Makefile-txt2tags-rules.mk;if [ -e $$X ];then echo $$X;  \
