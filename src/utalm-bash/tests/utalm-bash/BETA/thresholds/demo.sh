...
## \endcond
## @file
## @brief Demonstration of various thresholds calls.
##
...
#
echo "* printDBG-Call: set level 2 MIN">&2
printDBG      $S_ALL 3  $LINENO $BASH_SOURCE  "printDBG...LEVERL:3"
printDBG      $S_ALL 5  $LINENO $BASH_SOURCE  "printDBG...LEVERL:5"
echo>&2
