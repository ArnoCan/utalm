...
assert $LINENO $BASH_SOURCE  "[[ -n '$TESTMODE' ]]"
#do it by internal interfaces
case $TESTMODE in 
	$T_CREATEREF|$T_COMPAREREF|$T_FORCEOK|$T_PRINTREF|$T_PRINTVAL|$T_PRINTASSERT|$T_LISTREF)
		assertWithExit $LINENO $BASH_SOURCE 0
		;;
	*)
		assertWithExit $LINENO $BASH_SOURCE "$TESTMODE"
		;;
esac
assertWithExit $LINENO $BASH_SOURCE $E_SYS
## \endcond
