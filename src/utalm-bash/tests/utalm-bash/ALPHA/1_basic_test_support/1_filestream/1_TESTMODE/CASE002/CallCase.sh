...
export dataX
{
	...
	refx=$(TESTMODE=$((T_COMPAREREF|T_LISTREF)) assertRefDataWithExit $LINENO $BASH_SOURCE ID001 "$dataX" 2>&1)
	p=$(refDataStorePath ID001)	
	assertWithExit $LINENO $BASH_SOURCE "[[ '$refx' == '$p' ]]";
