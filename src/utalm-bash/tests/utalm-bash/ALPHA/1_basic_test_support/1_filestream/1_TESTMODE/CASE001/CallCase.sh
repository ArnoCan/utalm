...
####
#Testing the test-frame requires some extra effort
#
#echo "4TEST:$LINENO"
...
#echo "4TEST:$LINENO"
#TESTMODE=$((T_COMPAREREF|T_PRINTREF)) assertRefDataWithExit $LINENO $BASH_SOURCE ID001 "$dataX"
#echo "4TEST:$LINENO"
#TESTMODE=$((T_COMPAREREF|T_PRINTREF)) assertRefDataWithExit $LINENO $BASH_SOURCE ID001 "$dataX" 2>&1|sed '/utalm_exit:0/d'
#echo "4TEST:$LINENO"
#
####
export dataX
{
	...
	refx=$(TESTMODE=$((T_PRINTREF)) assertRefDataWithExit $LINENO $BASH_SOURCE ID001 "$dataX" 2>&1)
	[[ "<$dataX>" == "<$refx>" ]]&&{ echo "utalm_exit:0"; exit 0; }
