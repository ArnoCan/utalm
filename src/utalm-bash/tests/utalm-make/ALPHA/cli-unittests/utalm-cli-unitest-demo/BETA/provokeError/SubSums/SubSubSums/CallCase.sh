...
#
printINFO $D_DATA $LINENO $BASH_SOURCE 0 "expect=6"
UNIT_COUNTERRORS_OPTS="${_UNIT_COUNTERRORS_OPTS} expect=6" CallCase CASE000
#
printINFO $D_DATA $LINENO $BASH_SOURCE 0 "expect=1"
UNIT_COUNTERRORS_OPTS="${_UNIT_COUNTERRORS_OPTS} expect=1" CallCase CASE001 2>&1|countErrors.sh expect=1 
#
printINFO $D_DATA $LINENO $BASH_SOURCE 0 "expect=3"
UNIT_COUNTERRORS_OPTS="${_UNIT_COUNTERRORS_OPTS} expect=3" CallCase CASE002 
#
printINFO $D_DATA $LINENO $BASH_SOURCE 0 "expect=1"
UNIT_COUNTERRORS_OPTS="${_UNIT_COUNTERRORS_OPTS} expect=1" CallCase CASE003  2>&1|countErrors.sh expect=1  
#
{
